...
outputfilename = 'TubeCalibrationTable_512pixel_69122rear_TEST.nxs'
...
#list the files below in the following strip position sequence: [1040, 920, 755, 590, 425, 260, 95, 5] (LPC)
data_files = ["SANS2D00069122.nxs", "SANS2D00069117.nxs","SANS2D00069118.nxs", "SANS2D00069119.nxs",
              "SANS2D00069120.nxs", "SANS2D00069116.nxs","SANS2D00069121.nxs"]
              
uamphr = [108.8, 120, 120, 120, 120, 120, 120]
...
#COPY AND PASTE THE known_edge_pairs CORRESPONDENT TO YOUR STRIP POSITIONS. DON'T ERASE THE LINES BELOW! (LPC)
#known_edge_pairs = [[-0.562365234,-0.524046455],[-0.44052572, -0.402347555], [-0.27475211, -0.236573945], [-0.1089785, -0.070800335],
#                    [0.056795111, 0.094973275], [0.22350643, 0.261684595], [0.388342331, 0.426520496],[0.4787643, 0.516942465]]
# both edges of shadows in meters, generated through a separate excel file (Mask_gaps_60xxxfront_v2.xls)

output_name = '69122_rear'

known_edge_pairs = [[-0.5192, -0.493668], [-0.44052572, -0.402347555], [-0.27475211, -0.236573945], [-0.1089785, -0.070800335],
                    [0.056795111, 0.094973275], [0.22350643, 0.261684595], [0.4787643, 0.516942465]]

print ("Note that len(data_files) is",len(data_files), "and len(known_edge_pairs) is", len(known_edge_pairs))
...
boundaries = get_merged_edge_pairs_and_boundaries(known_edge_pairs)
...
for tube_id in range(120):
    ...
    print(('len(guessed_pixels) is:',len(guessed_pixels), guessed_pixels))
    print(('len(known_edges) is:',len(known_edges), known_edges))
