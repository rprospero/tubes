...
# index2 = 2*120*512 -1
# 16/9/19
data_files = ["SANS2D00064390.nxs", "SANS2D00064391.nxs", "SANS2D00064392.nxs", "SANS2D00064393.nxs",
              "SANS2D00064388.nxs", "SANS2D00064389.nxs"]
uamphr = [140, 143.3, 145.2, 82.5, 141.3, 142.2]
# can't be done automatically as this often needs hand tweaking
uamphr_to_rescale = 140.0

known_edge_pairs = [[-0.44052572, -0.402347555], [-0.27475211, -0.236573945], [-0.1089785, -0.070800335],
                    [0.056795111, 0.094973275], [0.22350643, 0.261684595], [0.388342331, 0.426520496],
                    [0.4787643, 0.516942465]]
# both edges of shadows in meters, generated through a separte excel file
output_name = '64393_rear'
#  16/9/19                    THIS IS FOR REAR  
data_files = ["SANS2D00064390.nxs", "SANS2D00064391.nxs", "SANS2D00064392.nxs", "SANS2D00064393.nxs",
              "SANS2D00064388.nxs", "SANS2D00064389.nxs"]
